...
public:
    rotate(byte (*matrix)[8],int rotation, int count):
    ...
    {};
        ...
        ///-matrix: Input data, the matrix its self will be altered, expectation is a (byte)matrix[8][8]. \n
        ...
        ///-c will become d. \n
        ///-d will become a. \n
        void rotator(byte & a, byte & b, byte & c, byte & d)
        {
            byte temp = a;
            a = b;
            b = c;
